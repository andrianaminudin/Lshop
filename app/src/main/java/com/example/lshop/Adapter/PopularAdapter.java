...
import com.example.lshop.Activity.DetailActivity;
import com.example.lshop.Domain.ItemModel;
import com.example.lshop.databinding.ViewholderPopularBinding;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull PopularAdapter.Viewholder holder, int position) {
        ...
        holder.binding.offPercentText.setText(items.get(position).getOffPercent() + " Off");
